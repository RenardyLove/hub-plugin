...
public class FileManager {
    ...
    {
        this.plugin = MainClass.getPlugin();
    }
    ...
    public class Config {
        ...
        public Config saveDefaultConfig() {
            file = new File(MainClass.getPlugin().getDataFolder(), this.name);

            MainClass.getPlugin().saveResource(this.name, false);
        ...
        public Config reload() {
            if (file == null)
                this.file = new File(MainClass.getPlugin().getDataFolder(), this.name);
            ...
            try
            {
                defConfigStream = new InputStreamReader(MainClass.getPlugin().getResource(this.name), "UTF8");
        ...
        {
            return get().getConfigurationSection(section);
        }
    }
